...
## Session 24: Add homepage entry actions

**Date**: 2026-05-23
**Task**: Add homepage entry actions
**Branch**: `main`

### Summary

Added compact homepage entry links for Blog, Projects, and About; verified check, tests, and build.
...
## Session 25: Add project status metadata

**Date**: 2026-05-24
**Task**: Add project status metadata
**Branch**: `main`

### Summary

Added controlled project status metadata, rendered status badges on project list items, validated sample content status values, and covered the schema/checker contract with tests.
...
## Session 26: Add reading category shortcuts

**Date**: 2026-05-24
**Task**: Add reading category shortcuts
**Branch**: `main`

### Summary

Added static Reading page category shortcuts backed by shared group anchor helpers, rendered section anchors, and covered stable anchor generation with tests.
...
## Session 27: Content route validation

**Date**: 2026-05-24
**Task**: Content route validation
**Branch**: `main`

### Summary

Added content validation support for generated blog tag and archive routes, with regression tests for valid and missing generated links.
...
## Session 28: Reusable back link component

**Date**: 2026-05-24
**Task**: Reusable back link component
**Branch**: `main`

### Summary

Extracted repeated back-link markup and styling into a shared Astro component and replaced matching usages across blog taxonomy, blog detail, project detail, and reading detail pages.
...
## Session 29: Align Docker Node runtime

**Date**: 2026-05-24
**Task**: Align Docker Node runtime
**Branch**: `main`

### Summary

Aligned the Docker build stage with the Node 20 CI baseline and documented the runtime policy. Verified npm run check, npm test, and npm run build; Docker Compose could not be verified because Docker CLI is unavailable in this WSL environment.
...
## Session 30: Content sync tests and badge shortcut reuse

**Date**: 2026-05-24
**Task**: Content sync tests and badge shortcut reuse
**Branch**: `main`

### Summary

Added isolated tests for the content sync script, refactored it behind a testable runSyncContent entry point, and reused Badge styling for reading category shortcuts.
...
## Session 31: Define deployment contract and health checks

**Date**: 2026-05-24
**Task**: Define deployment contract and health checks
**Branch**: `main`

### Summary

Documented the production rsync deployment contract, added dependency-free post-deploy health checks for the public static entry points, wired the GitHub Actions deploy workflow to run the check after upload, and verified tests, checks, build, and deployment guard behavior.
